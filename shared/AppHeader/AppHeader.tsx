...
export default function AppHeader() {
    return (
        <>
            <header className="hidden md:block bg-surface-container-lowest/70 backdrop-blur-2xl w-full sticky top-0 z-50 px-12 py-4 border-b border-white/5 shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
                <div className="w-full max-w-6xl mx-auto flex justify-between items-center">
                    <div className="flex gap-8 items-center">
                        ...
                        <nav className="flex gap-6 items-center text-sm font-medium text-white/50">
                            <Link
                                href="/dashboard"
