                ...
                <div className="hidden md:flex items-center gap-5">
                    ...
                    <div className="relative group">
                        <svg
                            ...
                            strokeWidth={2}
                            stroke="currentColor"
                            className="size-4 absolute left-3.5 top-1/2 -translate-y-1/2 text-white/30 group-focus-within:text-primary transition-colors duration-300"
                        >
                        ...
                        <input
                            ...
                            className="
                                ...
                                focus:bg-white/5 focus:border-primary/50 focus:shadow-[0_0_15px_rgba(0,255,163,0.15)]
                                w-48 focus:w-64 hover:border-white/20
                            "
                        />
                    </div>
